...
class PostgresConnectionParams(BaseModel):
    ...
    database: Optional[str] = Field(None, description="usermanagement")
    user: Optional[str] = Field(None, description="postgres")
    password: Optional[str] = Field(None, description="test")
    host: Optional[str] = Field(
        None,
        description="localhost",
    )
    port: Optional[str] = Field(
        None, description="5432"
    )
